				...
				<div class="container">
				     <div class="top-header">
                        ...
                        <%}
                                ...
                                <p style="font-family:'Times New Roman', Times, serif; font-size:15px; color:#08538c; text-align:center; margin-left:70%">WELCOME!<span>${name}</span><br><a href="Logout">Logout</a><%String ty=(String)request.getSession(false).getAttribute("type");
					...
					<div class="container">
						<h3>Become Partner </h3>
							<div class="about-grids">
								...
								<h4></h4>
                                 <h3 style="font-size:30px">Vendor association - </h3>
    <p style="color:#000; font-family:'Times New Roman', Times, serif; font-size:18px">If you want to associated with us then do please contact us at <b>+91-9412811555 / +91-8009810009</b> or mail us at <b style="color:hsla(359,90%,55%,1.00)">vendormanager@eatatos.com</b></p>   
<p style="color:#000; font-family:'Times New Roman', Times, serif; font-size:25px"><b>For other associations</b>&nbsp;Kindly mail us at <b>info@eatatos.com</b></p>
