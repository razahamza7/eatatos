...
out.println("<title>Eatatos.com  | Khilate hain dil se</title>");            
            ...
            try{
                 ...
                 String na =request.getParameter("city");
                String e=request.getParameter("em");
                String se=request.getParameter("sq");
           ...
           if(!se.equals("xx"))
           {
               Class.forName("com.mysql.jdbc.Driver");
                PreparedStatement ps;
                 ...
                 s="update user SET email=?, city=?, ques=?, ans=? where phone=?";
           ...
           RequestDispatcher r3=getServletContext().getRequestDispatcher("/CustomerHub?switch=Profile Edited Successfully");
                r3.forward(request, response);  
           }
           RequestDispatcher r3=getServletContext().getRequestDispatcher("/CustomerHub?switch=Profile Edited Unsuccessfully. Please Fill all the Details");
                r3.forward(request, response);  
                }
