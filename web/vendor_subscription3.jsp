<%-- 
    Document   : vendor_subscription3
    Created on : 9 Jun, 2016, 2:00:16 PM
    Author     : hp pc
--%>
...
<body>
 ...
 <p style="margin-left:90%; font-size:20px"><a href="vendor_menu_price.jsp">x</a></p>
	<p style="font-family:'Times New Roman', Times, serif; font-size:18px; color:#08538c; text-align:left">WELCOME!<br>Mr. xyz</p>
    <img id="logo" src="web_index/images/FINAL4.png" alt="logo" width="100" hight="100">
   
		<div class="row">
			<div class="twelve columns">
				<h2 align="center">Subscription Plan For Non-Veg</h2><br>
