...
<p style="font-family:'Times New Roman', Times, serif; font-size:15px; color:#08538c; text-align:center; margin-left:70%">WELCOME!<span>${name}</span><br><a href="Logout">Logout</a></p>		<div class="row">
			<div class="twelve columns">
				<img id="logo" src="images/FINAL4.png" alt="logo" width="100" hight="100"><h2 align="left">Subscription Plan For Non-Veg</h2><br>
				...
				<table class="responsive" style="margin-left:7%">
                  ...
                  <p align="center">
                     <input class="button1 button2" type="submit" value="EDIT">
                     <a class="button1 button2" href="create_vendor_menu_&_price.jsp">SAVE & CONTINUE</a>
                     </p>
               </div>
		     </div>
          </div>
